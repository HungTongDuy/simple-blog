...
import { getArticleDetail, clapArticle, followUser } from '../../../core/actions';
                            ...
                            <div className="uiScale uiScale-ui--regular uiScale-caption--regular postMetaLockup postMetaLockup--authorWithBio u-flexCenter js-postMetaLockup">
                                ...
                                <div className="u-flex1 u-paddingLeft15 u-overflowHidden">
                                    ...
                                    <div className="ui-caption postMetaInline js-testPostMetaInlineSupplemental">
                                        <time dateTime={articleDetail.createdAt}>{formatDate(articleDetail.createdAt)}</time><span className="middotDivider u-fontSize12"></span><span className="readingTime" title="5 min read"></span></div>
                                </div>
                            </div>
                        </div>
                    </div>
...
const mapDispatchToProps = (dispatch) => {
    return ({
        ...
        followUser: (id, userId, articleId) => dispatch(followUser(id, userId, articleId))
    });
}
