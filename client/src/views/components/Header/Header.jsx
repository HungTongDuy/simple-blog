                        ...
                        <div className="header-account">
                            ...
                            {!this.props.authUser.isAuth ? '' : 
                                <div className="group-user">
                                    <Link className="button" data-behavior="trigger-overlay" to="/editor">Write a story</Link>
                            ...
                            {this.props.authUser.isAuth ? '' : <a href="#" className="button green-border-button" onClick={this.handleOpen}>Sign In</a>}
